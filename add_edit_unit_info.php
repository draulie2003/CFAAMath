		...
		<div id="main-container">
			<div id="main">
				<div id="info">
					...
					<h3 class="sections">add / edit unit</h3>
					
					<div id="info_container">
						<form method='post' action='../add_edit_unit_confirmed.php' name='add_edit_student' class="pure-form pure-form-aligned">
							<fieldset>
...
<?php
								...
								if ($New_Unit == 'yes')
								{
									...
									echo "<div class='pure-control-group'>";
										echo "<label for='unit_num'>Unit Number</label>";
										echo "<input name='unit_num' type='text' placeholder='Unit Number'> New <input name='new' type='checkbox' value='Yes' checked>";
									echo "</div>";
									
									echo "<div class='pure-control-group'>";
										echo "<label for='unit_title'>Unit Title</label>";
										echo "<input name='unit_title' type='text' placeholder='Unit Title'>";
									echo "</div>";
								...
								else if ($New_Unit == 'no')
								{
									...
									echo "<div class='pure-controls'>";
										...
										echo "<button type='submit' class='pure-button pure-button-display'>Add / Update Unit</button>";
									echo "</div>";	
