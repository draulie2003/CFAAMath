...
<?php
							...
							if ($Completed)
							{	
								mysql_query("DELETE FROM unit_titles WHERE class = '" . $Class . "' and unit_num = '" . $Unit . "'");
								
								$confirm = mysql_query("SELECT * FROM unit_titles WHERE class = '" . $Class . "' and unit_num = '" . $Unit . "'");
								
								if (mysql_num_rows($confirm) == 0)
									echo "<br />Unit information deleted successfully!<br /><br />";
									
								else
									echo "<br />Whoops, unit information not deleted!<br /><br />";
