				...
				<div id="info">
					...
					<h3 class="sections">Confirm Delete</h3>
						...
						<div id="info_container">
							<form method='post' action='../confirm_video_deleted.php' name='add_edit_student' class="pure-form pure-form-aligned">
							<fieldset>
<?php
								...
								echo "<div class='pure-control-group'>";
									...
									echo "<input name='path' type='text' value='" . mysql_result($data, 0, "path") ."'>";
								echo "</div>";
